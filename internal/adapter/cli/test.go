...
func newTestStressCommand(svc port.ScaffoldService, globals *globalFlags) *cobra.Command {
	var engine string
	var force bool
...
func newTestChaosCommand(svc port.ScaffoldService, globals *globalFlags) *cobra.Command {
	var force bool
...
func newTestFuzzCommand(svc port.ScaffoldService, globals *globalFlags) *cobra.Command {
	var force bool
...
func newTestBenchmarkCommand(svc port.ScaffoldService, globals *globalFlags) *cobra.Command {
	var force bool
...
func newTestContainerCommand(svc port.ScaffoldService, globals *globalFlags) *cobra.Command {
	var force bool
...
func newTestMutationCommand(svc port.ScaffoldService, globals *globalFlags) *cobra.Command {
	var force bool
