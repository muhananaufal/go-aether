...
| `20260807-03` | [v0.4.0: Production Hardening, Framework Matrix & Real Brownfield Engine](20260807-v0.4.0-production-hardening.md) | Core Quality / Brownfield | `feature/v0.3.0-production-hardening` | `v0.4.0` | `IMPLEMENTED` | 2026-08-07 |
